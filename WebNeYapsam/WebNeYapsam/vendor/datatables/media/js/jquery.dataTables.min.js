...
oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"İleri",sPrevious:"Geri"},sEmptyTable:"Kayıt bulunmamaktadır.",sInfo:"Toplam _TOTAL_ veriden _START_ - _END_ veri listelenmektedir.",sInfoEmpty:"Toplam 0 veriden 0 - 0 veri listelenmektedir.",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ adet şeklinde listele",sLoadingRecords:"Yükleniyor...",sProcessing:"İşleniyor...",sSearch:"Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Eşleşen kayıt bulunmamaktadır."},oSearch:h.extend({},
